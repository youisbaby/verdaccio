...
module.exports = function(config, auth, storage) {
  ...
  app.param('anything', matchMiddleware(/.*/))
  ...
  app.get('/', renderViewMiddleware(config, auth, storage));

  // Static
  app.get('/-/static/:filename', function(req, res, next) {
    var file = path.join(__dirname, '/static/', req.params.filename);
    console.log('stadtic-:>', file);
